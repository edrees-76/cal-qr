...
namespace CAL_QR.Models
{
    ...
    public class DeviceType
    {
        ...
        //
        // ⚠ ولأن التمييز بين «مخفي عمداً» و«لم يُضبط قطّ» مستحيل في bool، فقد
        // تقرّر أن **الكتالوج يفرضهما فرضاً** على كل نوع يطابق اسماً معتمداً فيه
        // (DeviceTypeSeeder.Apply) — قائماً كان أو منشأً، وفي كل تشغيل للبذر.
        // خلافاً للحقول النصّية التي يحكمها «الملء لا الدهس» في FillBlanks.
        //
        // الأثر العملي: إخفاء قسم عدم اليقين أو المنهجية يدوياً على نوع من أنواع
        // الكتالوج **لا يدوم** — يعود عند أول تشغيل للبذر. تغييرُ عَلَمٍ لنوع
        // كتالوجي موضعه DeviceTypeCatalog لا قاعدة البيانات.
        // أنواع المستخدم خارج الكتالوج لا تُمسّ إطلاقاً.
        //
        // (ضبطهما في فرع الإنشاء وحده كان يترك كل نوع قائم بعَلَمين خاطئين،
        //  فيختفي القسمان في نافذة الشهادة بلا سبب ظاهر.)

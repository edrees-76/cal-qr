...
namespace CAL_QR.Repositories
{
    public class CertificateRepository : ICertificateRepository
    {
        ...
        /// <summary>
        /// 🔴 تبعية حاجزة على مرحلة طباعة الشهادة:
        /// هذه الدالّة **غير مستدعاة من أي مسار إنتاج حتى الآن** — طباعة الشهادة
        /// لم تُبنَ بعد. وحتى تُستدعى، تبقى السلسلة التالية معطّلة صامتة:
        ///     FirstPrintedAt يبقى null
        ///         ⇒ شرط AmendedAt لا يتحقق أبداً
        ///             ⇒ حالة ⚠ «عُدّلت هذه الشهادة» لا تظهر إطلاقاً.
        /// (مسار الرموز التاريخية يعمل، لكن بلا وسم تعديل.)
        ///
        /// أول طباعة فعلية للشهادة **يجب** أن تستدعي هذه الدالّة، وإلا شُحنت
        /// ميزة «الشهادة المعدَّلة» معطّلة دون أي إشارة فشل.
        ///
        /// ملاحظة على التغطية: اختبارات CertificateAmendmentTests تستدعيها يدوياً،
        /// فهي تغطي منطقاً سليماً لا يُستدعى بعد في الواقع.
        /// </summary>
